import {MainPage} from '../../pages/main-page/main-page/main-page';
...
import {MyListPage} from '../../pages/my-list-page/my-list-page/my-list-page';
...
import {AddReviewPage} from '../../pages/add-review-page/add-review-page/add-review-page';
